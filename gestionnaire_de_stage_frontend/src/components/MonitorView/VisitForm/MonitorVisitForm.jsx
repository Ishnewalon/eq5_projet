    ...
    return <form onSubmit={sendVisitForm}>
        ...
        <div className='px-3 pb-3 pt-1 rounded'>
            ...
            <FormGroup>
                <FormField>
                    <label>Commentaires</label>
                    <textarea name='commentaires_quatre' value={monitorVisitForm.commentaires_quatre} placeholder='Commentaires sur les habiletés personnelles du stagiaire'
                              onChange={e => handleChange(e)}/>
                </FormField>
            </FormGroup>
        </div>
        ...
        <div className='px-3 pb-3 pt-1 rounded'>
            ...
            <FormField>
                ...
                <select required title={'Le champ doit être rempli'} name='appreciation_globale' value={monitorVisitForm.appreciation_globale}
                        onChange={e => handleChange(e)}>
            ...
            <FormField>
                ...
                <select required title='Le champ doit être rempli' name='evaluation_discute_avec_etudiant'
                        value={monitorVisitForm.evaluation_discute_avec_etudiant} onChange={e => handleChange(e)}>
            ...
            <FormGroup>
                <FormField>
                    ...
                    <textarea required name='commentaires_cinq' title='Le champ doit être rempli' value={monitorVisitForm.commentaires_cinq}
                              onChange={e => handleChange(e)} placeholder='Commentaires sur la productivité du stagiaire'/>
                </FormField>
            </FormGroup>
            <FormGroup>
                <FormField>
                    <label>Veuillez indiquer le nombre d’heures réel par semaine d’encadrement accordé au
                        stagiaire</label>
                    <input required type="number" placeholder='Nombre heures réel par semaine' min='0' name='nb_heures_reel_travail_etudiant'
                           value={monitorVisitForm.nb_heures_reel_travail_etudiant}/>
                </FormField>
            </FormGroup>
        </div>
        <hr/>
        <div className='px-3 pb-3 pt-1 rounded'>
            <FormGroup>
                <FormField>
                    ...
                    <select required title="Le champ doit être rempli" name='entreprise_apprecie_etudiant'
                            value={monitorVisitForm.entreprise_apprecie_etudiant} onChange={e => handleChange(e)}>
                        <option value={true}>Oui</option>
                        <option value={false}>Non</option>
                    </select>
                </FormField>
            ...
            <FormGroup>
                <FormField>
                    <label>La formation technique du stagiaire était-elle suffisante pour accomplir le mandat de
                        stage?</label>
                    <textarea required title="Le champ doit être rempli" name="formation_suffisante_commentaire"
                              value={monitorVisitForm.formation_suffisante_commentaire} placeholder='Est-ce que la formation était suffisante?'
                              onChange={e => handleChange(e)}/>
                </FormField>
            </FormGroup>
            <FormGroup>
                <FormField>
                    <label>Nom</label>
                    <input required type="text" title='Le nom est requis' placeholder='Nom' value={monitorVisitForm.nom} onChange={e => handleChange(e)}/>
                </FormField>
                <FormField>
                    <label>Fonction</label>
                    <input required type="text" placeholder='Fonction' title='La fonction est requise' value={monitorVisitForm.fonction_deux} onChange={e => handleChange(e)}/>
                </FormField>
            </FormGroup>
            <FormGroup>
                <FormField>
                    <label>Signature</label>
                    <input type="text" name='monitor_signature' placeholder='Signature' title="La signature doit être rempli" value={monitorVisitForm.monitor_signature} onChange={e => handleChange(e)} />
                </FormField>
                <FormField>
                    <label>Date</label>
                    <input type="date" name='date_signature' title='La date doit être choisi' value={monitorVisitForm.date_signature} onChange={e => handleChange(e)} />
                </FormField>
            </FormGroup>
            <button type='submit' className='btn btn-primary w-100 mt-4 rounded fw-bold'>Créer un formulaire de visite</button>
        </div>
    </form>
}
