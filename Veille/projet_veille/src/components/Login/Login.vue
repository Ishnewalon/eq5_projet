<template>
    <div>
        <div>
            ...
            <div id="div">
                <button v-bind:class="getCurrentLogin()==='manager' ? 'btnSelected': 'btnSimple'"
                        v-on:click="handleClick('manager')">Gestionnaire
                </button>
            ...
            <div>
                <div class="form-group">
                    <input type="email" class="form-control" id="email" v-model.lazy="this.user.email"
                           placeholder="Email">
                </div>
                <div class="form-group">
...
export default {
    name: 'login',
    data: function () {
        return {currentLogin: 'student', user: {email: '', password: ''}, msgError: ''};
    },
    methods: {
        getCurrentLogin() {
