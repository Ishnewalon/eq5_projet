<template>
    <div>
        <form>
            ...
            <div>
                <input name="matricule" v-model.lazy="supervisor.matricule" type="text" placeholder="Matricule"
                       required/>
                ...
                <input name="password" v-model.lazy="supervisor.password" type="password" placeholder="Mot de passe"
                       required/>
            </div>
            <div>
                <p>{{ msgError }}</p>
