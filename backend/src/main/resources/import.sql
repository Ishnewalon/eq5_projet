...
INSERT INTO OFFER VALUES(1, '1000, avenue Bouchard', now(), now(), now(), 'Informatique', 'Programmeur Java', 'Lundi au Vendredi', '35h', '15 semaines', 28, 'Programmeur', true, 2);
INSERT INTO OFFER VALUES(14, '1000, avenue Bouchard', now(), now(), now(), 'Informatique', 'Dev React', 'Lundi au Vendredi', '35h', '15 semaines', 28, 'Dev', true, 2);
