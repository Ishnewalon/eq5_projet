...
INSERT INTO CONTRACT (ID, STUDENT_ID, OFFER_ID, MONITOR_ID, MANAGER_ID, CONTRACTPDF, SESSION_ID, MANAGER_SIGNATURE,MONITOR_SIGNATURE, STUDENT_SIGNATURE) VALUES (1, 5, 1, 2, 1, FILE_READ('src/main/resources/contratTemplate.pdf'), 3, null, null, null);
